...
/// Initialize the lazy build cache
///
/// This function creates and returns a new instance of the lazy build cache.
/// The cache is used to improve build performance by avoiding unnecessary rebuilds.
///
/// # Returns
///
/// A new instance of LazyBuildCache
pub fn lazy_build_cache() -> LazyBuildCache {
    LazyBuildCache::new()
}
