...
I joined [Okta](https://okta.com/) in 2020, working on [Auth0’s](https://auth0.com/) ecosystem of open-source SDKs. I also served as lead security engineer, guiding multi-quarter security initiatives, monitoring threats, responding to supply chain risks, and fostering a security-first engineering culture.

In 2024, I moved to [Okta’s Fine-Grained Authorization](https://www.okta.com/products/fine-grained-authorization/) team, where we’ve pioneered a high-performance, relationship-based access control (ReBAC) system—drawing inspiration from Google’s Zanzibar. My work spans [OpenFGA](https://openfga.dev/), our open-source project within the Cloud Native Computing Foundation (CNCF), and Okta’s platform built on top of it.
Where I’ve Been

Before Okta, I was a Senior Engineer at [Ushahidi](https://ushahidi.com/), an open-source platform used to crowdsource data in crises, defend democracy, and protect human rights. Security and privacy weren’t just features there—they were matters of life and death. That work shaped how I think about software: every decision carries weight.
...
You can reach me at [hello@evansims.com](mailto:hello@evansims.com). I’m on most social networks, but you’ll have the best luck connecting with me on [X](https://x.com/evansims), [Bluesky](https://bsky.app/profile/evansims.com) and [LinkedIn](https://linkedin.com/in/evansims?ref=evansims.com), which have been my platforms of choice lately.
